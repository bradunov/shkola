...
answer[1] = digit .. " " .. name_1 .. " i " .. digit .. " " .. name_4

value[2] = numb + numb/100;
answer[2] = digit .. " " .. name_1 .. " i " .. digit .. " " .. name_3 

value[3] = numb + numb/10;
answer[3] = digit .. " " .. name_1 .. " i " .. digit .. " " .. name_2
		
value[4] = numb + numb/100 + numb/1000;
ind = math.random(2)
if (ind == 1) then
   answer[4] = digit .. " " .. name_1 .. ", " .. digit .. " " .. name_3 .. " i " .. digit .. " " .. name_4
else
   answer[4] = digit .. " " .. name_1 .. " i " .. digit10 .. " " .. name_4 
end   
   	
value[5] = numb + numb/10 + numb/1000;
answer[5] = digit .. " " .. name_1 .. ", " .. digit .. " " .. name_2 .. " i " .. digit .. " " .. name_4        		                     

value[6] = numb + numb/10 + numb/100;
ind = math.random(2)ind = math.random(2)
if (ind == 1) then
   answer[6] = digit .. " " .. name_1 .. ", " .. digit .. " " .. name_2 .. " i " .. digit .. " " .. name_3 
else
   answer[6] = digit .. " " .. name_1 .. " i " .. digit10 .. " " .. name_3 
end   

value[7] = numb + numb/10 + numb/100 + numb/1000;
answer[7] = digit .. " " .. name_1 .. ", " .. digit .. " " .. name_2 .. ", " .. digit .. " " .. name_3 .. " i " .. digit .. " " .. name_4 
...
ind = math.random(2)
if (ind == 1) then
   answer[11] = digit .. " " .. name_3 .. " i " .. digit .. " " .. name_4
else
   answer[11] = digit10 .. " " .. name_4
end 
	
value[12] = numb/10 + numb/1000;
answer[12] = digit .. " " .. name_2 .. " i " .. digit .. " " .. name_4         		                     

value[13] = numb/10 + numb/100;
ind = math.random(2)
if (ind == 1) then
   answer[13] = digit .. " " .. name_2 .. " i " .. digit .. " " .. name_3 
else
