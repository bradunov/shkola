...
1) pretvaranjem mešovitih brojeva u neprave razlomke,
2) računanjem posebno celog dela mešovitog broja  i pravog razlomka  rezultata. 
Zapiši rezultat u najjednostavnijem obliku.
@vspace@
