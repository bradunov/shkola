...
lib.start_canvas(500, 100, "center", "result[0] == 0 && result[1] == 0 && result[2] == 0 && result[3] == 1 && result[4] == 1")
  ...
  lib.add_rectangle(180, 50, 60, 20, style, false, true)
  ...
  lib.add_rectangle(260, 50, 60, 20, different_style, false, false)
