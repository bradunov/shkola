...
lib.add_input(wy+2*ow+w, wy/2+2*ow-w, 30, 30, lib.check_string_case(tacka[1], 15))
lib.add_text(wy+2*ow, (wy+3*w)/2+2*ow, ".", dot_style, false, false)

lib.add_input(3*wy/2+ow, 2*ow+w, 30, 30, lib.check_string_case(tacka[2], 15))
lib.add_text(3*(wy/2+ow)-w, wy/2+ow, ".", dot_style, false, false)

lib.add_input(wy-2*ow+w, ow+w, 30, 30, lib.check_string_case(tacka[3], 15))
