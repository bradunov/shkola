...
if (ITEM == 4) then	
    ...
    reply = "answer == '" .. digit10 .. " " .. msg_thousand[2] .. " " .. digit .. " " .. name_2 .."'" ..
            "|| answer == '" .. digit10_L .. " " .. msg_thousand[2] .. " " .. digit_L .. " " .. name_2 .."'";	
    answer = "answer = '" .. digit10 .. " " .. msg_thousand[2] .. " " .. digit .. " " .. name_2 .."'";
end

if (ITEM == 5) then
    reply = "answer == '" .. digit10 .. " " .. digit .. " " .. name_3 .. " " .. digit .. " " .. name_2 .. " " .. digit2 .."'" ..
	        "|| answer == '" .. digit10_L .. " " .. digit_L .. " " .. name_3 .. " " .. digit_L .. " " .. name_2 .. " " .. digit2_L .."'";
    answer = "answer = '" .. digit10 .. " " .. digit .. " " .. name_3 .. " " .. digit .. " " .. name_2 .. " " .. digit2 .."'";
end	

if (ITEM == 6) then
    reply = "answer == '" .. digit10 .. " " .. msg_thousand[2] .. " " .. digit .. " " .. name_2 .. " " .. digit10 .."'" ..	         		                     
            "|| answer == '" .. digit10_L .. " " .. msg_thousand[2] .. " " .. digit_L .. " " .. name_2 .. " " .. digit10_L .."'";
    answer = "answer = '" .. digit10 .. " " .. msg_thousand[2] .. " " .. digit .. " " .. name_2 .. " " .. digit10 .."'"; 
end
