...
Koristeći cifre @hspace8pt@ @array_cifre[3]@, @hspace8pt@ @array_cifre[2]@ @hspace8pt@ i @hspace8pt@ @array_cifre[1]@  @hspace8pt@  zapiši sve dvocifrene brojeve redom od najvećeg do najmanjeg. Cifre mogu da se ponavljaju.
