...
mycanvas = function()
  ...
  ow = 10
   v = 5
    ...
    lib.add_line(v, ow, 2*ow+3*wh, 0, style, false, false)

  for i = 1,dim+1 do
    lib.add_line(v, 2*ow+i*wv, 2*ow+3*wh, 0, style, false, false)
  end
  
  lib.add_line(v, ow, 0, 3*wh-5*ow, style, false, false)
  lib.add_line(v+wh, ow, 0, 3*wh-5*ow, style, false, false)
