...
vscale = 5
  ...
  lib.add_input(25*hscale, 17*vscale, 50, 33, lib.check_number(number[2],20))  
  ...
  lib.add_input(75*hscale, 17*vscale, 50, 33, lib.check_number(number[4],20))

  lib.add_straight_path(120*hscale, 14*vscale, {{0, 10}}, style, false, true)  
  lib.add_input(100*hscale, 17*vscale, 50, 33, lib.check_number(number[5],20))  

  lib.add_straight_path(145*hscale, 14*vscale, {{0, 10}}, style, false, true)  
  lib.add_input(125*hscale, 17*vscale, 50, 33, lib.check_number(number[6],20))
  ...
  lib.add_input(175*hscale, 17*vscale, 50, 33, lib.check_number(number[8],20))

  lib.add_straight_path(220*hscale, 14*vscale, {{0, 10}}, style, false, true)
  lib.add_input(200*hscale, 17*vscale, 50, 33, lib.check_number(number[9],20))
