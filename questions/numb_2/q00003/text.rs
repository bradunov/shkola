...
@center@ U kom mestu je najhladnije? @hspacept(3)@ @lib.check_string_case(reply,15,ans)@
@vspace@
...
@center@ A poraste za 6@"°C"@ @hspacept(3)@ ona će  biti @lib.check_number(tempAr,20)@@"°C"@, 
@center@ @"H"@ opadne za 5@"°C"@ @hspacept(3)@ ona će  biti @lib.check_number(tempHf,20)@@"°C"@.                                              
