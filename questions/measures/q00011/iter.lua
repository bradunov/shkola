...
if (ITEM == 1) then
    quest[ITEM] = "Za koliko bi se promenila površina kutije ako bi se sve dimenzije kutije"
    if (index == 1) then
    ...
    quest[ITEM] = "Koliko puta bi se promenila površina kutije ako bi se sve dimenzije kutije"
    dif1 = dif * dif
	if (index == 1) then
