...
U koordinatnom sistemu se rotacijom trougao @"ABC"@, ( @"A"@(@ptx[1]@,@pty[1]@),  @"B"@(@ptx[2]@,@pty[2]@), @"C"@(@ptx[3]@,@pty[3]@) )  preslikava u trougao @"PQR"@. Ako je ugao rotacije @angle@ i @direction[sg]@ orjentisan, a centar rotacije tačka @point[ind]@ upiši koordinate trougla  @"PQR"@ (na jednu decimalu).    
@center@ @mycanvas()@   
