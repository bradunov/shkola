...
mycanvas = function(no)
  ...
  lib.add_input(w-v-5, 2*ow+3, 50, 30, numb[7])  

  lib.add_straight_path(v+ow+6, 2*v-4, {{v, -ow+3}, {-2*ow, 3*ow+4}}, ang_style[8], true, false) 
  lib.add_input(v+ow, v+ow+5,  50, 30, numb[8])
