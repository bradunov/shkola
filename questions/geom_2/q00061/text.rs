...
@vspace@                                
@center@ @mycanvas()@
Dopuni tvrđenja o podudarnosti trouglova  @name[1]@,  @name[2]@,  @name[3]@ i  @name[4]@ na slici (razdvoj oznake zapetom ako ih je više). Upiši na osnovu kog stava o podudarnosti to sledi.
@"r\(\small_1\) \(\small\neq\) r\(\small_2\)"@ 
