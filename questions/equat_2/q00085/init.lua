...
equ[2] = lib.frac_start() .. lib.check_number(coef[1], 20) .. lib.frac_mid() .. lib.check_string(arg[1],20) .. lib.frac_end() .. " " .. lib.check_string("+", 10) .. " " .. lib.frac_start() .. lib.check_number(coef[1], 20) .. lib.frac_mid() .. lib.check_string(arg[2],20) .. lib.frac_end() .. lib.check_string("+", 10) .. lib.frac_start() .. lib.check_number(coef[3], 20) .. lib.frac_mid() .. lib.check_string(arg[2],20) .. lib.frac_end() .. " = " .. lib.check_number(1, 20) 	
